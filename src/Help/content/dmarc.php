...
return [
    ...
    new HelpArticle(
        ...
        '<p><code>p=reject</code> asks receivers to refuse DMARC-failing mail outright, typically with an SMTP-level bounce, rather than delivering or quarantining it. This is the end goal for a domain that wants full anti-spoofing protection — it is only safe to set once you have confirmed, from real aggregate report data, that every legitimate sending source for the domain is passing SPF or DKIM with alignment.</p>'
